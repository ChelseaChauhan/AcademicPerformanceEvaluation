...
import com.example.myproject.BarChartActivity;
import com.example.myproject.Extra;
...
public class StudentRecordRecyclerAdapter extends RecyclerView.Adapter<StudentRecordRecyclerAdapter.ViewHolder> {
    private ArrayList<Beneficiary> studentrecordArraylist;
    private Context context;


    public StudentRecordRecyclerAdapter(ArrayList<Beneficiary> studentrecordArraylist, Context context) {
        this.studentrecordArraylist = studentrecordArraylist;
        this.context = context;
    }

    @NonNull
    @Override
    public StudentRecordRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // on below line we are inflating our layout
        // file for our recycler view items.
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_student_record_recycler, parent, false);
        return new StudentRecordRecyclerAdapter.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull StudentRecordRecyclerAdapter.ViewHolder holder, int position) {

        Beneficiary modal = studentrecordArraylist.get(position);
    ...
    public int getItemCount() {
        ...
        return studentrecordArraylist.size();
    }
